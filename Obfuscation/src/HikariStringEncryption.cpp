...
// Imported from https://github.com/61bcdefg/Hikari-LLVM15-Core/blob/e5a17492941da587c0430a6f3f2d3accb3ad7df6/StringEncryption.cpp
...
PreservedAnalyses HikariStringEncryptionPass::run(Module &M, ModuleAnalysisManager& AM) {
...
GlobalVariable* HikariStringEncryptionPass::ObjectiveCString(GlobalVariable *GV, std::string name,
...
HikariStringEncryptionPass *llvm::createHikariStringEncryption(bool flag){
    return new HikariStringEncryptionPass(flag);
}
